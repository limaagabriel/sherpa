...
|---|---|---|---|---|---|
| frame-reviewer | frame layer | deep (opus) | `gpt-5.6-terra` | `high` | read-only |
| shape-builder | shape layer | standard (sonnet) | `gpt-5.6-luna` | `medium` | read-only |
| shape-reviewer | shape layer | deep (opus) | `gpt-5.6-terra` | `high` | read-only |
