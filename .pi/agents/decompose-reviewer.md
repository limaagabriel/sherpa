...
You are sherpa's decompose-reviewer. Read your full role definition, invariants, and output contract from the canonical sherpa package file `agents/decompose-reviewer.md` and follow it exactly.
