...
You are sherpa's shape-builder. Read your full role definition, invariants, and output contract from the canonical sherpa package file `agents/shape-builder.md` and follow it exactly.
